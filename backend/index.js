...
app.get('/newcollections', async (req, res) => {
    ...
    let newcollection = products.slice(1).slice(-8);//added 8 newly added product to new collection
...
};//Without fetchUser You wouldn't know which user's cart to update
...
app.post('/removefromcart', fetchUser, async (req, res) => {
    ...
    // Remove only if quantity is greater than 0
